...
export default function Page12_15Bus() {
  ...
  return (
    <View style={{ flex: 1, backgroundColor: 'white' }}>
      <Image style={{ height: 330, width: 373, alignItems: 'center', }}
        source={require('../img/bus15.jpg')} />
      <ScrollView>
        ...
        <SafeAreaView style={{ flex: 1, backgroundColor: 'white' }}>
          ...
          <View style={{ marginBottom: 5, marginTop: 15 }}>
              <Button color="#FF2511" onPress={ShowMenu8} title={` Bhatti Chowk  \u2193`} />
              {
            ...
            <View style={{ marginBottom: 5, marginTop: 5 }}>
              <Button color="#FF2511" onPress={ShowMenu} title={` Nasir Baig   \u2193`} />
              {
            ...
            <View style={{ marginBottom: 5, marginTop: 5 }}>
              <Button color="#FF2511" onPress={ShowMenu2} title={`MAO College  \u2193`} />
              {
            ...
            <View style={{ marginBottom: 5, marginTop: 5 }}>
              <Button color="#FF2511" onPress={ShowMenu1} title={`Anarkali   \u2193`} />
              {
            ...
            <View style={{ marginBottom: 5, marginTop: 5 }}>
              <Button color="#FF2511" onPress={ShowMenu3} title={`Janazgah   \u2193`} />
              {
            ...
            <View style={{ marginBottom: 5, marginTop: 5 }}>
              <Button color="#FF2511" onPress={ShowMenu4} title={` Qartaba  \u2193`} />
              {
            ...
            <View style={{ marginBottom: 5, marginTop: 5 }}>
              <Button color="#FF2511" onPress={ShowMenu5} title={`Lahore College   \u2193`} />
              {
            ...
            <View style={{ marginBottom: 5, marginTop: 5 }}>
              <Button color="#FF2511" onPress={ShowMenu6} title={`Services Hospital  \u2193`} />
              {
            ...
            <View style={{ marginBottom: 5, marginTop: 5 }}>
              <Button color="#FF2511" onPress={ShowMenu7} title={`Kinnard College   \u2193`} />
              {
            ...
            <View style={{ marginBottom: 5, marginTop: 5 }}>
              <Button color="#FF2511" onPress={ShowMenu9} title={`Main Market \u2193`} />
              {
            ...
            <View style={{ marginBottom: 5, marginTop: 5 }}>
              <Button color="#FF2511" onPress={ShowMenu10} title={`Mini Market  \u2193`} />
              {
            ...
            <View style={{ marginBottom: 5, marginTop: 5 }}>
              <Button color="#FF2511" onPress={ShowMenu11} title={`Hafeez Center  \u2193`} />
              {
            ...
            {/* ---------------------------------------------------- */}
            <View style={{ marginBottom: 5, marginTop: 5 }}>
              <Button color="#FF2511" onPress={ShowMenu12} title={`Liberty Chowk   \ \u2193`} />
              {
            ...
            <View style={{ marginBottom: 5, marginTop: 5 }}>
              <Button color="#FF2511" onPress={ShowMenu13} title={`Center Point  \u2193`} />
              {
            ...
            <View style={{ marginBottom: 5, marginTop: 5 }}>
              <Button color="#FF2511" onPress={ShowMenu14} title={`Firdous Market Bus Stop   \u2193`} />
              {
            ...
            <View style={{ marginBottom: 5, marginTop: 5 }}>
              <Button color="#FF2511" onPress={ShowMenu15} title={`T Stop   \u2193`} />
              {
            ...
            <View style={{ marginBottom: 5, marginTop: 5 }}>
              <Button color="#FF2511" onPress={ShowMenu16} title={`Nadeem Chowk   \u2193`} />
              {
                show14 && (<Text style={{ marginLeft: 5, marginTop: 5, padding: 5, color: '#000000' }}>
                  FRT15 RA Bazar  {"\n"}
                  Start Time 7:29AM {"\n"}
            ...
            <View style={{ marginBottom: 5, marginTop: 5 }}>
              <Button color="#FF2511" onPress={ShowMenu17} title={`RA Bazar   \u2193`} />
              {
                show15 && (<Text style={{ marginLeft: 5, marginTop: 5, padding: 5, color: '#000000' }}>
                  FRT15 RA Bazar  {"\n"}
                  Start Time 7:31 AM {"\n"}
